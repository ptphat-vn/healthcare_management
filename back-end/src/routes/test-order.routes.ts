...
testOrderRouter.delete(
  '/test-orders/:id',
  authMiddleware,
  privilegeMiddleware(['delete_test_order']),
  deleteTestOrderController
)
...
// Test Order Review
testOrderRouter.post(
  '/test-orders/:id/review',
  authMiddleware,
  privilegeMiddleware(['review_test_order']),
  validateReviewTestOrder,
  reviewTestOrderController
)
testOrderRouter.post(
  '/test-orders/:id/ai-review',
  authMiddleware,
  privilegeMiddleware(['review_test_order']),
  aiReviewTestOrderController
)
...
testOrderRouter.put(
  '/test-orders/:testOrderId/comments/:commentId',
  authMiddleware,
  privilegeMiddleware(['modify_comment']),
  validateUpdateComment,
  updateCommentController
)
testOrderRouter.delete(
  '/test-orders/:testOrderId/comments/:commentId',
  authMiddleware,
  privilegeMiddleware(['delete_comment']),
  deleteCommentController
)
