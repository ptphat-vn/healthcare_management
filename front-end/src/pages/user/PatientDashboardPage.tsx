...
export default function PatientDashboardPage() {
  ...
  const fullName = user?.data?.fullName ?? "Bệnh nhân";
  const avatar =
    user?.data?.avatar ??
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-xl rounded-2xl bg-white px-6 py-12 shadow-sm border border-slate-100 text-center space-y-6">
        ...
        <p className="text-sm text-slate-500">
          Đây là phiên bản dashboard tối giản. Bạn có thể nhấn nút bên dưới để mở
          giao diện chat và kiểm tra chức năng.
        </p>
